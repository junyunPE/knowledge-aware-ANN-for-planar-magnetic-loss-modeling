...
path='D:\\Magnetic simulation\\python\\core loss\\programme\\parallel(SE)\\data(N87).csv'
...
data.to_csv('D:\\Magnetic simulation\\python\\core loss\\programme\\parallel(SE)\\data_test(N87200).csv')
...
data1.to_csv('D:\\Magnetic simulation\\python\\core loss\\programme\\parallel(SE)\\data_val(N87200).csv')
