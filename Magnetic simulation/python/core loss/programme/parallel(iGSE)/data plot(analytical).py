...
path='D:\\file\\ECCE\\Magnetic simulation\\python\\core loss\\programme\\parallel(iGSE)\\data(3C94).csv'
...
path='D:\\file\\ECCE\\Magnetic simulation\\python\\core loss\\programme\\parallel(iGSE)\\data(N87).csv'
temp=pd.read_csv(path,header=0)
temp=np.array(temp)
data=abs(temp[:,7]*100)
freq1=[]
