...
path='D:\\Magnetic simulation\\python\\core loss\\programme\\parallel(original)\\data(N87).csv'
...
data.to_csv('D:\\Magnetic simulation\\python\\core loss\\programme\\parallel(original)\\data_test(N87200).csv')
...
data1.to_csv('D:\\Magnetic simulation\\python\\core loss\\programme\\parallel(original)\\data_val(N87200).csv')
